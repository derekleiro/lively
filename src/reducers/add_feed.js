...
export const AddTodosReducer = (state = { todos: [] }, action) => {
    switch (action.type) {
        ...
        case "EDIT_TODO":
            ...
            if (
                action.payload.complete === 0 ||
                action.payload.complete === 1
            ) {
            ...
            if (
                action.payload.important === 0 ||
                action.payload.important === 1
            ) {
        ...
        case "COMPLETE_TODO":
            ...
            return (state = {
                ...state,
                todos:
                    setTime(todo_to_complete.dueDate) !== "Today"
                        ? state.todos.filter(
                              (todo) =>
                                  todo.todo_url !== todo_to_complete.todo_url
                          )
                        : state.todos,
            });
