...
import lists_icon from "../../assets/icons/lists.png";
import completed from "../../assets/icons/completed.png";

import all_light from "../../assets/icons/all_light.png";
import star_light from "../../assets/icons/star_light.png";
import lists_icon_light from "../../assets/icons/lists_light.png";
import list_color from "../../assets/icons/list_color.png";
import completed_light from "../../assets/icons/completed_light.png";
...
const ListsFeed = () => {
    ...
    useEffect(() => {
        ...
        if (!unmounted) {
            setLists(lists_feed);
            const default_count = lists_feed.filter(
                            ...
                            return (
                                <div key={index}>
                                    <List
                                        name={list.name}
                                        icon={completed}
                                        icon_light={completed_light}
                                        default={true}
                                        id={list.list_id}
                                        index={index}
                                        default_values={
                                            completed_ || list.values
                                        }
                                    />
                                </div>
                            );
