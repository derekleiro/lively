...
const Time = (props) => {
	...
	return (
		<div className="category" style={{ marginTop: "35px" }}>
			<div style={{ marginBottom: "15px", marginLeft: "5px" }}>Focus for:</div>
			<div className="category_select" style={style.style2}>
				<Option selected={selected} value={900} handleSelect={handleSelect} />
				<Option selected={selected} value={1800} handleSelect={handleSelect} />
				<Option selected={selected} value={2700} handleSelect={handleSelect} />
				<Option selected={selected} value={3600} handleSelect={handleSelect} />
				<Option selected={selected} value={4500} handleSelect={handleSelect} />
				<Option selected={selected} value={5400} handleSelect={handleSelect} />
				<Option selected={selected} value={6300} handleSelect={handleSelect} />
				<Option selected={selected} value={7200} handleSelect={handleSelect} />
			</div>
		</div>
	);
};
