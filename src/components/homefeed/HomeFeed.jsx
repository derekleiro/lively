...
const HomeFeed = () => {
    ...
    const todo_yesterday = tasks
        .filter(
            (task) =>
                setTime(task.dueDate) === "Yesterday" && task.complete === 0
        )
        .sort((todoA, todoB) => {
            return todoA.dueDate - todoB.dueDate;
        });
    ...
    const todo_tomorrow = tasks
        .filter(
            (task) =>
                setTime(task.dueDate) === "Tomorrow" && task.complete === 0
        )
        .sort((todoA, todoB) => {
            return todoA.dueDate - todoB.dueDate;
        });
    ...
    const todo_later = tasks
        .filter(
            (task) => setTime(task.dueDate) === "Later" && task.complete === 0
        )
        .sort((todoA, todoB) => {
            return todoA.dueDate - todoB.dueDate;
        });
                                ...
                                onClick={() => {
                                    AppRate.setPreferences = {
                                        ...
                                        storeAppURL: {
                                            ...
                                            android:
                                                "market://details?id=com.lively.life",
                                        },
                                        customLocale: {
