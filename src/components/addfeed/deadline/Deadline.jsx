    ...
    const handleSelect = async (selected) => {
        if (selected === "Pick a date") {
            ...
            if (selected === "Today") {
                ...
                dispatch(
                    goal_deadline(new Date().setDate(new Date().getDate() + 1))
                );
        ...
        <div className="category" style={{ marginTop: "35px" }}>
            ...
            {selectDate ? (
                <div
                    ...
                    style={selectDate2 ? style.style3 : style.style1}
                    onClick={() => {
                        if (selectedDate) {
                ...
                >
                    ...
                    >
                        ...
                        <div className="option_name">
                            {selectedDate
                                ? setTime(goal_deadline_state)
                                : "Select a date"}
                        </div>
                    </div>
                    {selectDate2 ? (
                        <div className="date_select_picker">
                            <DayPicker onDayClick={handleSelectedDate} />
                        </div>
                    ) : null}
                </div>
            ) : selecting ? (
