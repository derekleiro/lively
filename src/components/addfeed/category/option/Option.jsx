...
const Option = (props) => {
    ...
    const selected_value = useSelector((state) => state.todo_list_selected);
            ...
            {props.deleteOption ? (
                ...
                >
                        ...
                        <Done load={true}>
                            <div className="done_options">
                                <img
                                    ...
                                    alt={`You are about to delete the list "${props.value}" are you sure?`}
                                />
                    ...
                    <img
                        ...
                        alt={`Delete the list "${props.value}"`}
