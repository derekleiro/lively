...
export const set_urgency = (data) => {
	return {
		type: "HANDLE_URGENCY_SET",
		payload: data,
	};
};

export const reset_urgency = (data) => {
	return {
		type: "HANDLE_URGENCY_RESET",
		payload: data,
	};
};
...
export const goals_tag_clear = (data) => {
	return {
		type: "HANDLE_TODOS_TAG_CLEAR",
		payload: data,
	};
};
...
export const handle_date_completed = (data) => {
	return {
		type: "HANDLE_DATE_COMPLETED",
		payload: data,
	};
};

export const reset_date_completed = {
	type: "RESET_DATE_COMPLETED",
};
